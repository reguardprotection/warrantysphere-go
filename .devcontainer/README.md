...
```
speakeasy generate usage -s /Users/ross/Obligo-API-Reference.yaml -l go -i {INPUT_OPERATION_ID} -o ./samples
```

- To generate samples for an entire namespace (like a tag or group name), use:

```
speakeasy generate usage -s /Users/ross/Obligo-API-Reference.yaml -l go -n {INPUT_TAG_NAME} -o ./samples
```
